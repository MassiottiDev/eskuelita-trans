...
const Footer = () => {
  return <footer id="contact" className="bg-yellow-400 text-gray-800">
      <div className="container mx-auto px-4 py-10 bg-white/90 rounded-lg shadow-lg">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center space-y-6 md:space-y-0">
          <div className="flex items-center space-x-2">
            ...
            <a href="https://www.google.com/maps/search/?api=1&query=Juan+Carlos+Gómez+1581,+Montevideo,+Uruguay" target="_blank" rel="noopener noreferrer" className="hover:text-gray-600 transition-colors">Montevideo, Uruguay</a>
          </div>
        ...
        <div className="mt-8 pt-4 border-t border-yellow-500 text-center text-sm">© 2025 Eskuelita Trans*. Todos los Derechos Reservados.</div>
      </div>
    </footer>;
};
